export default function test (){
  return (
        ...
        <div className="flex flex-wrap -mx-4">
          <div className="w-full px-4 md:w-1/2 lg:w-1/4">
            <div className="mb-12 wow fadeInUp group" data-wow-delay=".1s">
              ...
              >
                <span
                  className="absolute left-0 top-0 -z-1 mb-8 flex h-[70px] w-[70px] rotate-[25deg] items-center justify-center rounded-[14px] bg-primary/20 duration-300 group-hover:rotate-45"
                ></span>
                <svg
                  width="37"
                  height="37"
        ...
        <div className="container px-4 mx-auto">
          <div className="flex flex-wrap -mx-4">
            <div className="w-full px-4 md:w-2/3 lg:w-1/2">
              <div className="my-1">
                <div
                  className="flex items-center justify-center -mx-3 md:justify-start"
                >
                  <a
                    href="javascript:void(0)"
    ...
    >
      ...
      <span className="block w-px h-4 bg-stroke dark:bg-dark-3"></span>
