    ...
    <div className="rounded-2xl border border-gray-200 bg-white pt-4 dark:border-white/[0.05] dark:bg-white/[0.03]">
      <div className="flex flex-col gap-2 px-5 mb-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
        ...
        <div className="flex gap-5">
          <Button className="h-[42px]" variant="outline">
            Import
          </Button>
      ...
      <div className="overflow-hidden">
        <div className="max-w-full px-5 overflow-x-auto sm:px-6">
          <table className="min-w-full undefined">
            <thead className="border-gray-100 border-b dark:border-white/[0.05]">
              <tr>
      ...
      <div className="px-6 py-4 border-gray-200 dark:border-white/[0.05]">
